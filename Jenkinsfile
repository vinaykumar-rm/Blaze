    ...
    stage('Git Clone') {
      parallel {
        ...
        stage('RSConnect') {
          steps {
            dir(path: 'rsconnect') {
              git(url: 'https://github.com/riversandtechnologies/rsconnect.git', branch: 'dev', credentialsId: 'b5ef282b-30a9-4b58-95c2-c72fe65b0091')
            }
        ...
        stage('RSDAM') {
          steps {
            dir(path: 'rsdam') {
              git(url: 'https://github.com/riversandtechnologies/rsdam.git', branch: 'dev', credentialsId: 'b5ef282b-30a9-4b58-95c2-c72fe65b0091')
            }
        ...
        stage('UI') {
          steps {
            dir(path: 'ui') {
              git(url: 'https://github.com/riversandtechnologies/ui-platform.git', branch: 'dev', credentialsId: 'b5ef282b-30a9-4b58-95c2-c72fe65b0091')
            }
...
sudo ./build.sh $WORKSPACE/docker $packageversion${TAG_SUFFIX}
